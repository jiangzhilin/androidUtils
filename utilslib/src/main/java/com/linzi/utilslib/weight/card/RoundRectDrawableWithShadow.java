 ...
 */
package com.linzi.utilslib.weight.card;
...
class RoundRectDrawableWithShadow extends android.graphics.drawable.Drawable {
    ...
    RoundRectDrawableWithShadow(Resources resources, ColorStateList backgroundColor, float radius,
        ...
        if (shadowColorStart == null) {
            mShadowStartColor = ColorStateList.valueOf(Color.parseColor("#999999"));
        } else {
            mShadowStartColor = shadowColorStart;
        }
        if (shadowColorEnd == null) {
            mShadowEndColor = ColorStateList.valueOf(Color.parseColor("#00000000"));
        } else {
